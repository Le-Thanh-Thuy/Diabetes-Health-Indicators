...
-   R\^2=0.1397: Chỉ 13.97% sự biến thiên của BMI được giải thích bởi
...
R\^2=0.1397: Chỉ 13.97% sự biến thiên của BMI được giải thích bởi các
biến độc lập trong mô hình, không thay đổi so với lúc chưa bỏ biến
no_docbc_cost.
...
Mô hình mới có sự cải thiện R\^2 từ 13.97% lên 14.56 %
